...
export default function PatientListPage() {
  ...
  const statistics = useMemo(() => {
    ...
    return {
      ...
      maleRatio:
        patients.length > 0
          ? Math.round((maleCount / patients.length) * 100)
          : 0,
      femaleRatio:
        patients.length > 0
          ? Math.round((femaleCount / patients.length) * 100)
          : 0,
    };
                ...
                <DatePicker
                  ...
                  customInput={
                    ...
                    >
                      <span
                        className={
                          isCustomActive ? "text-white" : "text-gray-700"
                        }
                      >
                        시작 날짜
                      </span>
                      <span
                        className={
                          isCustomActive ? "text-white" : "text-gray-900"
                        }
                      >
      ...
      >
        {detailLoading ? (
          ...
          <div className="px-10 py-1">
            {/* 헤더 */}
            <h2 className="text-2xl font-bold text-gray-900 mb-4">환자 정보</h2>

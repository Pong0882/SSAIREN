...
//import com.example.ssairen_app.viewmodel.PatientTypeState
//
//@Composable
//fun PatientType(
...
//) {
//    // ✅ API 상태 관찰
//    val patientTypeState by activityViewModel.patientTypeState.observeAsState(PatientTypeState.Idle)
...
//            is PatientTypeState.Success -> {
//                val apiData = state.patientTypeResponse.data.data.incidentType
//
//                // 카테고리 매핑
//                mainType = apiData.category ?: ""
//
//                // 병력 매핑
//                apiData.medicalHistory?.let { medical ->
//                    hasMedicalHistory = medical.hasHistory ?: ""
//                    medicalHistoryList = medical.details?.toSet() ?: setOf()
//                }
//
//                // 범죄 의심 매핑
//                apiData.legalSuspicion?.let { legal ->
//                    if (legal.isSuspected == true) {
//                        crimeOption = legal.actions?.firstOrNull() ?: ""
//                    }
//                }
//
//                // 외상 유형 매핑
//                apiData.externalCause?.let { external ->
//                    subType = external.type ?: ""
//                    accidentVictimType = external.subType ?: ""
//                }
//
//                // 기타 매핑
//                apiData.other?.let { other ->
//                    etcType = other.category ?: ""
//                }
//            }
//            is PatientTypeState.Error -> {
//                // 에러 처리 (필요시 Toast 표시)
//                android.util.Log.e("PatientType", "API 오류: ${state.message}")
//            }
...
//
//    // ✅ 로딩 중일 때 표시
//    if (patientTypeState is PatientTypeState.Loading) {
//        Box(
//            modifier = Modifier
//                .fillMaxSize()
